...
class UnitData:
    ...
    def setSerialToSlot(self, undo: ChangeUndoRecord, srlNumber: str, slot: int):
...
class PropertiesData:
    ...
    def SetAll(self, undo: ChangeUndoRecord, data: dict[UnitType, dict[str, Union[str, int, float, bool]]]):
