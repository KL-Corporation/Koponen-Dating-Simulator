...
EaseInCirc = lambda t: 1 - math.sqrt(1 - pow(t, 2))
EaseOutCirc = lambda t: math.sqrt(1 - pow(t - 1, 2))
EaseInOutCirc = lambda t: (1 - math.sqrt(1 - pow(2 * t, 2))) * 0.5 if t < 0.5 else (math.sqrt(1 - pow(-2 * t + 2, 2)) + 1) * 0.5
...
EaseOutBounce = lambda t: easeOutBounce(t)
